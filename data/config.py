...
cig_butts_dataset = dataset_base.copy({
  ...
  'train_info': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/cig_butts/train/coco_annotations.json',
  'train_images': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/cig_butts/train/images/',
  'valid_info': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/cig_butts/val/coco_annotations.json',
  'valid_images': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/cig_butts/val/images/',
  'class_names': ('cig_butt'),
  'label_map': { 1:  1 }
})
#--------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------
mecano_dataset = dataset_base.copy({
    'name': 'Mecano Dataset',
    'train_info': '''D:/Repos/_mecano/data/mecano/train/coco_annotations.json''',
    'train_images': '''D:/Repos/_mecano/data/mecano/train/images/''',
    'valid_info': '''D:/Repos/_mecano/data/mecano/val/coco_annotations.json''',
    'valid_images': '''D:/Repos/_mecano/data/mecano/val/images/''',
    'class_names': ('smallhole','zakor'),
    'label_map': {1: 1, 2: 2}
})
#--------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------
waste_dataset = dataset_base.copy({
    'name': 'waste_dataset',
    'train_info': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/waste/train/coco_annotations.json',
    'train_images': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/waste/train/images/',
    'valid_info': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/waste/val/coco_annotations.json',
    'valid_images': 'D:/КАНДИДАТСКАЯ ДИССЕРТАЦИЯ/Helpfull Demos/mecano/data/waste/val/images/',
    'class_names': ('wood','metal', 'plastic'),
...
#-- Mecano ---------------------------------------------------------------
yolact_resnet50_mecano_config = yolact_resnet50_config.copy({
    'name': 'mecano',
    # Dataset stuff
    'dataset': mecano_dataset,
    'num_classes': len(mecano_dataset.class_names) + 1,
...
#-------------------------------------------------------------------------
yolact_resnet50_waste_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_waste',
    # Dataset stuff
    'dataset': waste_dataset,
    'num_classes': len(waste_dataset.class_names) + 1,
